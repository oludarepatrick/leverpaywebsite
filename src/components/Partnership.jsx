...
const Partnership = () => {
    return (
        <div className="container mx-auto bg-white px-2">
            <h2 className="text-blue-shade-20 font-primaryAgrandirBold text-2xl text-center pb-4 pt-8">International
            ...
            <div className="md:flex md:justify-evenly md:items-center md:gap-8 ">
                <ul className="flex flex-col gap-4 md:gap-6">
                    ...
                    <li className="bg-blue-shade-15 font-primaryRegular text-orange-shade-20 text-base p-4 pl-6 rounded-lg">Enjoy Instant Remittance</li>
