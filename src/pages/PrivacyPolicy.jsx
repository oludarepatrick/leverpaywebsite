    ...
    return (
        <div className="container mx-auto p-4 bg-white text-blue-shade-20">
          <div className="container mx-auto p-8 bg-blue shadow-lg rounded-lg border border-gray-200 
           ...
           <h2 className="font-primarySemiBold md:text-2xl text-xl py-4">Overview</h2>
           <p className="text-justify pb-2 leading-7 font-primaryRegular">
           ...
           <h2 className="font-primarySemiBold md:text-2xl text-xl py-4">How We Handle Collected Information</h2>
           <p className="text-justify pb-2 leading-7 font-primaryRegular">
           ...
           <h2 className="font-primarySemiBold md:text-2xl text-xl py-4">Visitors to Our Website</h2>
           <p className="text-justify pb-2 leading-7 font-primaryRegular">
           ...
           <h2 className="font-primarySemiBold md:text-2xl text-xl py-4">Safeguarding Your Information</h2>
           <p className="text-justify pb-2 leading-7 font-primaryRegular">
           ...
           <h2 className="font-primarySemiBold md:text-2xl text-xl py-4">Cookies</h2>
           <p className="text-justify pb-2 leading-7 font-primaryRegular">
           ...
           <h2 className="font-primarySemiBold md:text-2xl text-xl py-4">Data Storage</h2>
           <p className="text-justify pb-2 leading-7 font-primaryRegular">
           ...
           <h2 className="font-primarySemiBold md:text-2xl text-xl py-4">Regular Review and Update</h2>
           <p className="text-justify pb-2 leading-7 font-primaryRegular italic">
